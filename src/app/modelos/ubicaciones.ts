...
export const PROVINCIAS: Provincia[] = [
  {
    ...
    cantones: [
      ...
      { nombre: 'Pérez Zeledón', distritos: ['San Isidro de El General', 'El General', 'Daniel Flores', 'Rivas', 'San Pedro', 'Platanares', 'Pejibaye', 'Cajón', 'Barú', 'Río Nuevo', 'Páramo', 'La Amistad'] },
  ...
  },
  {
    ...
    cantones: [
      ...
      { nombre: 'San Ramón', distritos: ['San Ramón', 'Santiago', 'San Juan', 'Piedades Norte', 'Piedades Sur', 'San Rafael', 'San Isidro', 'Ángeles', 'Alfaro', 'Volio', 'Concepción', 'Zapotal', 'Peñas Blancas', 'San Lorenzo'] },
      ...
      { nombre: 'Zarcero', distritos: ['Zarcero', 'Laguna', 'Tapezco', 'Guadalupe', 'Palmira', 'Zapote', 'Brisas'] },
      { nombre: 'Sarchí', distritos: ['Sarchí Norte', 'Sarchí Sur', 'Toro Amarillo', 'San Pedro', 'Rodríguez'] },
      { nombre: 'Upala', distritos: ['Upala', 'Aguas Claras', 'San José', 'Bijagua', 'Delicias', 'Dos Ríos', 'Yolillal'] },
      { nombre: 'Los Chiles', distritos: ['Los Chiles', 'Caño Negro', 'El Amparo', 'San Jorge'] },
      { nombre: 'Guatuso', distritos: ['San Rafael', 'Buena Vista', 'Cote', 'Katira'] },
      { nombre: 'Río Cuarto', distritos: ['Río Cuarto', 'Santa Rita', 'Santa Isabel'] },
    ],
  },
  {
    nombre: 'Cartago',
    cantones: [
      { nombre: 'Cartago', distritos: ['Oriental', 'Occidental', 'Carmen', 'San Nicolás', 'Agua Caliente', 'Guadalupe', 'Corralillo', 'Tierra Blanca', 'Dulce Nombre', 'Llano Grande', 'Quebradilla'] },
      ...
      { nombre: 'El Guarco', distritos: ['Tejar', 'San Isidro', 'Tobosi', 'Patio de Agua'] },
    ],
  },
  {
    nombre: 'Heredia',
